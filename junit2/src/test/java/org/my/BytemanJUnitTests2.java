...
{
    /**
     * this is the same code as {@link org.my.BytemanJUnitTests#testPipeline} but it uses a Byteman rule to throw an
     * IOException in the pattern replacer before it can processes any text lines. The pattern replacer
     * thread should catch the exception, close its input and output streams and exit, causing the writer
     * to finish with an empty output. All the pipeline threads should exit cleanly.
     * @throws Exception
     */
    @Test
